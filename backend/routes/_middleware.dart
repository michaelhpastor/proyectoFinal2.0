...
Handler middleware(Handler handler) {
  return handler
      .use(requestLogger())
      .use(_provideRepoUsuario())
      .use(_provideRepoEstablecimientos())
      .use(_provideRepoEspecialistas())
      .use(_provideRepoEmpleados())
      .use(_provideRepoAgendaEspecialistas())
      .use(_provideRepoAgendaEmpelados())
...
Middleware _provideRepoEmpleados() {
  return provider((context) => repositorioEmpelado(_prisma));
}
